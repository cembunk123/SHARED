        ...
        function fetchData() {
            $.ajax({
                ...
                success: function (datamx) {
					...
					changeLineColor('#line1', data.vst, "");
                    changeLineColor('#line2', data.vst, "");
                    changeLineColor('#line3', data.vst, "");
                    changeLineColor('#line4', data.vst, "");
                    changeLineColor('#line5', data.vst, "");
                    changeLineColor('#bay1', data.vst, "");
                    changeLineColor('#bay2', data.vst, "");
                    changeLineColor('#bay3', data.vst, "");
                    changeLineColor('#bay4', data.vst, "");
                    changeLineColor('#bay5', data.vst, "");
                },
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    //BCU
                    IchangeBoxColor('#box_d40etherfail', data.d40etherfail, "ETHERNET FAIL PROT PANEL");
                    ...
                    IchangeBoxColor('#box_d34etherfail', data.d34etherfail, "ETHERNET FAIL CONTROL PANEL");
