...
$query = "SELECT * FROM mx WHERE bay='trafo1'";
...
if ($result->num_rows > 0) {
    ...
    $ir2 = $row[array_keys($row)[20]];
    $is2 = $row[array_keys($row)[21]];
    $it2 = $row[array_keys($row)[22]];
    $mw2 = $row[array_keys($row)[23]];
    $mvar2 = $row[array_keys($row)[24]];
}
