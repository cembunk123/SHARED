        ...
        function fetchDataTrafo1() {
            $.ajax({
                ...
                success: function (datamx) {
					...
					changeLineColor('#trf1_bay1', data.vst, "");
                    changeLineColor('#trf1_bay2', data.vst, "");
                    changeLineColor('#trf1_bay3', data.vst, "");
                    changeLineColor('#trf1_bay4', data.vst, "");
                    changeLineColor('#trf1_bay5', data.vst, "");
                    changeLineColor('#trf1_line1', data.vst, "");
                    changeLineColor('#trf1_line2', data.vst, "");
                    changeLineColor('#trf1_line3', data.vst, "");
                    changeLineColor('#trf1_line4', data.vst, "");
                    changeLineColor('#trf1_line5', data.vst, "");
                },
                error: function (xhr, status, error) {
                    console.error('Error:', error);
                }
