...
<head>
    ...
    <script>
        ...
        function fetchDataC264() {
            $.ajax({
                url: '../backend/trafo1/get_datac264.php', // URL file PHP
                method: 'GET',
                dataType: 'json', // Mengharapkan data JSON
                success: function (datac264) {
                    ...
                    changeBoxColor('#box_ac_dcfailpp', datac264.ac_dcfailpp, "AC / DC Fail Panel Proteksi");
                    ...
                    changeBoxColor('#box_cb_lpb', datac264.cb_lpb, "CB SF6 LOW Pressure Block");
                    changeBoxColor('#box_tcsa', datac264.tcsa, "TCS Alarm");
                    changeBoxColor('#box_cbsf', datac264.cbsf, "CB Spring Fail");
                    changeBoxColor('#box_ac_dcfailcb', datac264.ac_dcfailcb, "AC / DC Supply for CB Fail");
                    changeBoxColor('#box_bcuf', datac264.bcuf, "BCU Failure");
                    changeBoxColor('#box_bcurf', datac264.bcurf, "BCU Ring Railure");
                    changeBoxColor('#box_swf', datac264.swf, "Switch Failure");
                    changeBoxColor('#box_swrf', datac264.swrf, "Switch Ring Failure");
                    ...
                    changeBoxColor('#box_buca', datac264.buca, "Buchloz Alarm");
                    changeBoxColor('#box_bcut', datac264.bcut, "Bucholz Trip");
                    changeBoxColor('#box_otia', datac264.otia, "Oil Temperature Alarm");
                    changeBoxColor('#box_otit', datac264.otit, "Oil Temperature Trip");
                    changeBoxColor('#box_wtia', datac264.wtia, "Winding Temperature Alarm");
                    changeBoxColor('#box_wtit', datac264.wtit, "Winding Temperature Trip");
                    changeBoxColor('#box_olt', datac264.olt, "OLTC Protection Relay Trip");
                    changeBoxColor('#box_ol', datac264.ol, "OLTC / Main Tank Oil Level Low");
                    changeBoxColor('#box_cff', datac264.cff, "Cooling Fan Failure");
                    changeBoxColor('#box_omf', datac264.omf, "Tap Changer Motor Failure");
                    changeBoxColor('#box_avrf', datac264.avrf, "AVR Fail");
                    changeBoxColor('#box_fansuppf', datac264.fansuppf, "Trafo FAN AC / DC Supply Fail");
                    changeBoxColor('#box_prt', datac264.prt, "Pressure Relay OLTC / MT Trip");
        ...
        <div class="desktop-1 screen " data-id="12:85">
            <div class="alarm-Ys8k0x" data-id="18:75">
                ...
                <div class="signal10-0AvDFH" data-id="18:11">
                    <div id="box_ac_dcfailpp" class="box">AC/DC Fail Panel Proteksi</div>
                </div>
                ...
                <div class="signal25-0AvDFH" data-id="18:33">
                    <div id="box_cb_lpb" class="box">CB SF6 LOW Pressure Block</div>
                </div>
                <div class="signal30-0AvDFH" data-id="18:34">
                    <div id="box_tcsa" class="box">TCS Alarm</div>
                </div>
                <div class="signal35-0AvDFH" data-id="18:39">
                    <div id="box_cbsf" class="box">CB Spring Fail</div>
                </div>
                <div class="signal40-0AvDFH" data-id="18:44">
                    <div id="box_ac_dcfailcb" class="box">AC/DC Supply for CB Fail</div>
                </div>
                <div class="signal44-0AvDFH" data-id="18:48">
                    <div id="box_tap" class="box"></div>
                </div>
                <div class="signal4-0AvDFH" data-id="18:6">
                    <div id="box_cff" class="box">Cooling Fan Failure</div>
                </div>
                <div class="signal8-0AvDFH" data-id="18:10">
                    <div id="box_omf" class="box">Tap Changer Motor Failure</div>
                </div>
                <div class="signal13-0AvDFH" data-id="18:16">
                    <div id="box_avrf" class="box">AVR Fail</div>
                </div>
                <div class="signal18-0AvDFH" data-id="18:22">
                    <div id="box_fansuppf" class="box">Trafo FAN AC/DC Supply Fail</div>
                </div>
                <div class="signal23-0AvDFH" data-id="18:27">
                    <div id="box_prt" class="box">Pressure Relay OLTC / MT Trip</div>
                </div>
                ...
                <div class="signal7-0AvDFH" data-id="18:9">
                    <div id="box_buca" class="box">Buchloz Alarm</div>
                </div>
                <div class="signal12-0AvDFH" data-id="18:15">
                    <div id="box_bcut" class="box">Bucholz Trip</div>
                </div>
                ...
                <div class="signal27-0AvDFH" data-id="18:31">
                    <div id="box_wtia" class="box">Winding Temperature Alarm</div>
                </div>
                <div class="signal32-0AvDFH" data-id="18:36">
                    <div id="box_wtit" class="box">Winding Temperature Trip</div>
                </div>
                <div class="signal37-0AvDFH" data-id="18:41">
                    <div id="box_olt" class="box">OLTC Protection Relay Trip</div>
                </div>
                <div class="signal42-0AvDFH" data-id="18:46">
                    <div id="box_ol" class="box">OLTC / Main Tank Oil Level Low</div>
                </div>
                ...
                <div class="signal11-0AvDFH" data-id="18:14">
                    <div id="box_swf" class="box">Switch Failure</div>
                </div>
                <div class="signal16-0AvDFH" data-id="18:20">
                    <div id="box_swrf" class="box">Switch Ring Failure</div>
                </div>
            ...
            <div class="measurement-Ys8k0x measurement" data-id="12:78">
                ...
                <div class="measurement-BNLOE4 measurement fjallaone-normal-white-32px" data-id="1:23">TRAFO 1</div>
