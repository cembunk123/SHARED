...
<head>
    ...
    <script>
        ...
        function fetchDataC264() {
            $.ajax({
                url: '../backend/trafo3/get_datac264.php', // URL file PHP
                method: 'GET',
                dataType: 'json', // Mengharapkan data JSON
                success: function (datac264) {
                    ...
                    changeBoxColor('#box_idf', datac264.idf, "DS Driving Failure");
                    changeBoxColor('#box_mcbmkf', datac264.mcbmkf, "MCB In MK Trip");
                    ...
                    changeBoxColor('#box_lor', datac264.lor, "Lockout Trip Relay Operated");
                    ...
                    changeBoxColor('#box_wtihva', datac264.wtihva, "HV Winding Temperature Alarm");
                    changeBoxColor('#box_wtihvt', datac264.wtihvt, "HV Winding Temperature Trip");
                    changeBoxColor('#box_jt', datac264.jt, "Jansen Trip");
                    changeBoxColor('#box_spt', datac264.spt, "Sudden Pressure Trip");
                    changeBoxColor('#box_fmsf', datac264.fmsf, "Fan Motor Supply Fail");
                    changeBoxColor('#box_mcbdf', datac264.mcbdf, "MCB Motor Drive Failure");
                    changeBoxColor('#box_ola', datac264.ola, "Oil Level Alarm");
                    changeBoxColor('#box_wtilva', datac264.wtilva, "LV Winding Temperature Alarm");
                    changeBoxColor('#box_wtilvt', datac264.wtilvt, "LV Winding Temperature Trip");
                    changeBoxColor('#box_avrb', datac264.avrb, "AVR Block");
                    changeBoxColor('#box_mcbpt', datac264.mcbpt, "MCB In PP / CP Trafo Trip");
                },
                error: function (xhr, status, error) {
                    console.error('Error:', error);
                }
        ...
        <div class="desktop-1 screen " data-id="12:85">
            <div class="alarm-Ys8k0x" data-id="18:75">
                ...
                <div class="signal5-0AvDFH" data-id="18:7">
                    <div id="box_idf" class=" box">DS Driving Failure</div>
                </div>
                <div class="signal10-0AvDFH" data-id="18:11">
                    <div id="box_mcbmkf" class=" box">MCB In MK Trip</div>
                </div>
                ...
                <div class="signal4-0AvDFH" data-id="18:6">
                    <div id="box_ola" class=" box">Oil Level Alarm</div>
                </div>
                <div class="signal8-0AvDFH" data-id="18:10">
                    <div id="box_wtilva" class=" box">LV Winding Temperature Alarm</div>
                </div>
                <div class="signal13-0AvDFH" data-id="18:16">
                    <div id="box_wtilvt" class=" box">LV Winding Temperature Trip</div>
                </div>
                <div class="signal18-0AvDFH" data-id="18:22">
                    <div id="box_avrb" class=" box">AVR Block</div>
                </div>
                <div class="signal23-0AvDFH" data-id="18:27">
                    <div id="box_mcbpt" class=" box">MCB In PP/CP Trafo Trip</div>
                </div>
                ...
                <div class="signal17-0AvDFH" data-id="18:21">
                    <div id="box_wtihva" class=" box">HV Winding Temperature Alarm</div>
                </div>
                <div class="signal22-0AvDFH" data-id="18:26">
                    <div id="box_wtihvt" class=" box">HV Winding Temperature Trip</div>
                </div>
                ...
                <div class="signal37-0AvDFH" data-id="18:41">
                    <div id="box_fmsf" class=" box">Fan Motor Supply Fail</div>
                </div>
                ...
                <div class="signal11-0AvDFH" data-id="18:14">
                    <div id="box_lor" class=" box">Lockout Trip Relay Operated</div>
                </div>
            ...
            <div class="measurement-Ys8k0x measurement" data-id="12:78">
                ...
                <div class="measurement-BNLOE4 measurement fjallaone-normal-white-32px" data-id="1:23">TRAFO 3</div>
