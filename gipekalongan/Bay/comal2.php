...
<head>
    ...
    <script>
        ...
        function fetchDataMX() {
            $.ajax({
                url: '../backend/comal2/get_datamx.php', // URL file PHP
                method: 'GET',
        ...
        function fetchDataC264() {
            $.ajax({
                url: '../backend/comal2/get_datac264.php', // URL file PHP
                method: 'GET',
                dataType: 'json', // Mengharapkan data JSON
                success: function (datac264) {
                    ...
                    changeBoxColor('#box_mto_k404', datac264.mto_k404, "Lockout Trip Relay K404 Operated");
                    changeBoxColor('#box_mto_k405', datac264.mto_k405, "Lockout Trip Relay K405 Operated");
        ...
        // Fungsi untuk mengambil data dari get_datacf87.php dan menampilkan di halaman
        function fetchDataF87() {
            $.ajax({
                url: '../backend/comal2/get_dataf87.php', // URL file PHP
                method: 'GET',
                dataType: 'json', // Mengharapkan data JSON
                success: function (dataf87) {

                    // Mengubah warna kotak berdasarkan nilai variabel
                    changeBoxColor('#box_cd', dataf87.cd, "F87L Line Current Diff.Operated");
                    changeBoxColor('#box_cdar', dataf87.cdar, "F87L Line Current Diff.Phs.R");
                    changeBoxColor('#box_cdas', dataf87.cdas, "F87L Line Current Diff.Phs.S");
                    changeBoxColor('#box_cdat', dataf87.cdat, "F87L Line Current Diff.Phs.T");
                    changeBoxColor('#box_distancez1', dataf87.distancez1, "Distance Zone 1 Operated");
                    changeBoxColor('#box_dz1r', dataf87.dz1r, "Distance Zone 1 Operated Phs R");
                    changeBoxColor('#box_dz1s', dataf87.dz1s, "Distance Zone 1 Operated Phs S");
                    changeBoxColor('#box_dz1t', dataf87.dz1t, "Distance Zone 1 Operated Phs T");
                    changeBoxColor('#box_distancez2', dataf87.distancez2, "Distance Zone 2 Operated");
                    changeBoxColor('#box_dz2r', dataf87.dz2r, "Distance Zone 2 Operated Phs R");
                    changeBoxColor('#box_dz2s', dataf87.dz2s, "Distance Zone 2 Operated Phs S");
                    changeBoxColor('#box_dz2t', dataf87.dz2t, "Distance Zone 2 Operated Phs T");
                    changeBoxColor('#box_distancez3', dataf87.distancez3, "Distance Zone 3 Operated");
                    changeBoxColor('#box_dz3r', dataf87.dz3r, "Distance Zone 3 Operated Phs R");
                    changeBoxColor('#box_dz3s', dataf87.dz3s, "Distance Zone 3 Operated Phs S");
                    changeBoxColor('#box_dz3t', dataf87.dz3t, "Distance Zone 3 Operated Phs T");
                    changeBoxColor('#box_def_aided', dataf87.def_aided, "DEF AIDED");
                    changeBoxColor('#box_def_send', dataf87.def_send, "DEF SEND");
                    changeBoxColor('#box_def_receive', dataf87.def_receive, "DEF RECEIVE");
                    changeBoxColor('#box_f21_aided', dataf87.f21_aided, "F21 AIDED");
                    changeBoxColor('#box_f21_send', dataf87.f21_send, "F21 SEND");
                    changeBoxColor('#box_f21_receive', dataf87.f21_receive, "F21 RECEIVE");
                    changeBoxColor('#box_switchontofault', dataf87.switchontofault, "Switch On to Fault");
                    changeBoxColor('#box_ar_success', dataf87.ar_success, "Autoreclose Successful");
                    changeBoxColor('#box_comm_fail', dataf87.comm_fail, "COMM FAIL");
                    changeBoxColor('#box_psb', dataf87.psb, "Power Swing Block");
                    changeBoxColor('#box_arnotready', dataf87.arnotready, "AR - Not Ready");
                    changeBoxColor('#box_vtf', dataf87.vtf, "VT Failure");
                    changeBoxColor('#box_tpf', dataf87.tpf, "TP Failure");
                    changeBoxColor('#box_arip', dataf87.arip, "Autoreclose In Progress");
                    changeBoxColor('#box_spar', dataf87.spar, "Single Phase AR Operated");
                    changeBoxColor('#box_tpar', dataf87.tpar, "Three Phase AR Operated");
                },
                error: function (xhr, status, error) {
                    console.error('Error:', error);
                }
        ...
        function fetchDataF50() {
            $.ajax({
                url: '../backend/comal2/get_dataf50.php', // URL file PHP
                method: 'GET',
                dataType: 'json', // Mengharapkan data JSON
        ...
        <div class="desktop-1 screen " data-id="12:85">
            <div class="alarm-Ys8k0x" data-id="18:75">
                <div class="signal50-0AvDFH" data-id="18:54">
                    <div id="box_cdar" class=" box">F87L Line Current Diff. Phs. R</div>
                </div>
                <div class="signal45-0AvDFH" data-id="18:49">
                    <div id="box_cd" class=" box">F87L Line Current Diff. Operated</div>
                </div>
                ...
                <div class="signal55-0AvDFH" data-id="18:59">
                    <div id="box_cdas" class=" box">F87L Line Current Diff. Phs. S</div>
                </div>
                ...
                <div class="signal60-0AvDFH" data-id="18:64">
                    <div id="box_cdat" class=" box">F87L Line Current Diff. Phs. T</div>
                </div>
                ...
                <div class="signal65-0AvDFH" data-id="18:70">
                    <div id="box_switchontofault" class=" box">Switch On to Fault</div>
                </div>
                <div class="signal66-0AvDFH" data-id="18:71">
                    <div id="box_ar_success" class=" box">Autoreclose Successful</div>
                </div>
                <div class="signal68-0AvDFH" data-id="18:73">
                    <div id="box_psb" class=" box">Power Swing Block</div>
                </div>
                <div class="signal67-0AvDFH" data-id="18:72">
                    <div id="box_comm_fail" class=" box">COMM FAIL</div>
                </div>
                ...
                <div class="signal9-0AvDFH" data-id="18:13">
                    <div id="box_f21_send" class=" box">F21 SEND</div>
                </div>
                <div class="signal14-0AvDFH" data-id="18:18">
                    <div id="box_f21_receive" class=" box">F21 RECEIVE</div>
                </div>
                <div class="signal19-0AvDFH" data-id="18:23">
                    <div id="box_spar" class=" box">Single Phase AR Operated</div>
                </div>
                <div class="signal24-0AvDFH" data-id="18:28">
                    <div id="box_tpar" class=" box">Three Phase AR Operated</div>
                </div>
                <div class="signal4-0AvDFH" data-id="18:6">
                    <div id="box_def_aided" class=" box">DEF AIDED</div>
                </div>
                <div class="signal8-0AvDFH" data-id="18:10">
                    <div id="box_def_send" class=" box">DEF SEND</div>
                </div>
                <div class="signal13-0AvDFH" data-id="18:16">
                    <div id="box_def_receive" class=" box">DEF RECEIVE</div>
                </div>
                <div class="signal18-0AvDFH" data-id="18:22">
                    <div id="box_arnotready" class=" box">AR-Not Ready</div>
                </div>
                <div class="signal23-0AvDFH" data-id="18:27">
                    <div id="box_vtf" class=" box">VT Failure</div>
                </div>
                <div class="signal28-0AvDFH" data-id="18:30">
                    <div id="box_tpf" class=" box">TP Failure</div>
                </div>
                <div class="signal33-0AvDFH" data-id="18:37">
                    <div id="box_arip" class=" box">Autoreclose In Progress</div>
                </div>
                ...
                <div class="signal21-0AvDFH" data-id="18:25">
                    <div id="box_mto_k404" class=" box">Lockout Trip Relay K404 Operated</div>
                </div>
                <div class="signal26-0AvDFH" data-id="18:32">
                    <div id="box_mto_k405" class=" box">Lockout Trip Relay K405 Operated</div>
                </div>
            ...
            <div class="measurement-Ys8k0x measurement" data-id="12:78">
                ...
                <div class="measurement-BNLOE4 measurement fjallaone-normal-white-32px" data-id="1:23">COMAL 2</div>
