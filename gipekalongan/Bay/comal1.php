...
<head>
    ...
    <script>
        ...
        function fetchDataMX() {
            $.ajax({
                url: '../backend/comal1/get_datamx.php', // URL file PHP
                method: 'GET',
        ...
        function fetchDataC264() {
            $.ajax({
                url: '../backend/comal1/get_datac264.php', // URL file PHP
                method: 'GET',
                dataType: 'json', // Mengharapkan data JSON
        ...
        function fetchDataF87() {
            $.ajax({
                url: '../backend/comal1/get_dataf87.php', // URL file PHP
                method: 'GET',
                dataType: 'json', // Mengharapkan data JSON
        ...
        function fetchDataF50() {
            $.ajax({
                url: '../backend/comal1/get_dataf50.php', // URL file PHP
                method: 'GET',
                dataType: 'json', // Mengharapkan data JSON
    ...
    <div class="container-center-horizontal">
        <div class="desktop-1 screen " data-id="12:85">
            ...
            <div class="measurement-Ys8k0x measurement" data-id="12:78">
                ...
                <div class="measurement-BNLOE4 measurement fjallaone-normal-white-32px" data-id="1:23">COMAL 1</div>
